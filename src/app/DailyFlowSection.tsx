    ...
    <div id="daily-flow" className="bg-[#f9f5e7] py-20 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          {/* picture */}
          <div className="w-full h-auto relative shrink-0">
          ...
          <div className="flex-1 w-full">
            <div className="space-y-3">
              {['8:30~ ご自宅にお迎え', '9:00~ 体調チェック', '9:30~ 入浴', '12:00~ 昼食', '13:30~ 機能訓練（個別対応）', '15:00~ おやつ・ティータイム', '15:30~ 体操・レクリエーション', '16:30~ ご自宅まで送迎'].map((text, index) => (
                <div key={index} className="flex items-center" onClick={() => { setImageIndex(index + 1); setSelectedIndex(index); }}>
                  <div className={`w-full py-2 px-4 rounded-md ${selectedIndex === index ? 'bg-[#f0ebe0]' : ''}`}>
