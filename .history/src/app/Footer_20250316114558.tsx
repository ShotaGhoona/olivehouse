...
const Footer = () => (
    <footer className="bg-[#ffe4a3] py-8 px-4 text-center">
        {/* Logo placeholder - will be added later */}
        <div className="w-20 h-20 mx-auto mb-6 flex items-center justify-center">
        <svg id="グループ_12" data-name="グループ 12" xmlns="http://www.w3.org/2000/svg" width="183.061" height="186.119" viewBox="0 0 183.061 186.119">
            <defs>
        ...
        {/* Tagline */}
        <h2 className="text-xl md:text-3xl font-bold text-[#2c5530] mb-6">楽しく過ごせる、時を大切に</h2>

        {/* Service type and name */}
        <div className="mb-6">
        <p className="text-lg font-medium text-[#2c5530] mb-1">デイサービス</p>
        <p className="text-xl font-bold text-[#2c5530]">オリーブの家</p>
        </div>
