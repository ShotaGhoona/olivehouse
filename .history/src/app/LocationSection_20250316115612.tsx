    ...
    <div id="location" className="min-h-screen bg-[#f9f5e7] py-12 px-4 md:px-8">
        <div className={`w-full max-w-4xl mx-auto py-12 px-4`}>
            ...
            <div className="w-full aspect-[16/9] md:aspect-[21/9] bg-[#f5f0e0] rounded-lg mb-8">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d370.4509900405291!2d135.47961609346942!3d34.5426762447754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000db003596e20f%3A0xb55584965f5e8f0!2z44OH44Kk44K144O844OT44K5IOOCquODquODvOODluOBruOBhOOBiA!5e0!3m2!1sja!2sjp!4v1742093706765!5m2!1sja!2sjp" width="600" height="450" style={{ border: 0 } as React.CSSProperties} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
