...
const Footer = () => (
    <footer className="bg-[#ffe4a3] py-8 px-4 text-center">
        ...
        <svg id="グループ_12" data-name="グループ 12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="183.061" height="186.119" viewBox="0 0 183.061 186.119">
            <defs>
